 ...
 * @return APR_SUCCESS if all went well
 */
ngx_int_t find_jgroupsid(mem_t *s, jgroupsidinfo_t **jgroupsid, const char *route);
 ...
 * @return APR_SUCCESS if all went well
 */
ngx_int_t (* read_jgroupsid)(int ids, jgroupsidinfo_t **jgroupsid);
/**
 ...
 */
ngx_int_t (*find_jgroupsid)(jgroupsidinfo_t **jgroupsid, const char *route);
};
#endif /*JGROUPSID_H*/
