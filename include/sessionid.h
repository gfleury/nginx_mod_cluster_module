 ...
 * @return APR_SUCCESS if all went well
 */
ngx_int_t (* read_sessionid)(int ids, sessionidinfo_t **sessionid);
/**
 ...
 */
ngx_int_t (*remove_sessionid)(sessionidinfo_t *sessionid);
/*
 * Insert a new sessionid or update existing one.
 */
ngx_int_t (*insert_update_sessionid)(sessionidinfo_t *sessionid);
};
#endif /*SESSIONID_H*/
