 ...
 */
typedef ngx_int_t mc_slotmem_callback_fn_t(void* mem, void **data, int ident, ngx_pool_t *pool);
 ...
 * @return APR_SUCCESS if all went well
 */
ngx_int_t (* ap_slotmem_do)(ap_slotmem_t *s, mc_slotmem_callback_fn_t *func, void *data, int new_version, ngx_pool_t *pool);
 ...
 * @return APR_SUCCESS if all went well
 */
ngx_int_t (* ap_slotmem_create)(ap_slotmem_t **new, const u_char *name, size_t item_size, int item_num, int persistent, ngx_pool_t *pool, ngx_conf_t *cf, ngx_http_module_t *ngx_http_module);
 ...
 * @return APR_SUCCESS if all went well
 */
ngx_int_t (* ap_slotmem_init)(ap_slotmem_t **new, const u_char *name, size_t item_size, int item_num, ngx_pool_t *pool);
 ...
 * @return APR_SUCCESS if all went well
 */
ngx_int_t (* ap_slotmem_attach)(ap_slotmem_t **new, const u_char *name, size_t *item_size, int *item_num, ngx_pool_t *pool);
/**
 ...
 */
ngx_int_t (* ap_slotmem_mem)(ap_slotmem_t *s, int item_id, void**mem);
/**
 ...
 * @return APR_SUCCESS if all went well
 */
ngx_int_t (* ap_slotmem_alloc)(ap_slotmem_t *s, int *item_id, void**mem); 
/**
 ...
 * @return APR_SUCCESS if all went well
 */
ngx_int_t (* ap_slotmem_free)(ap_slotmem_t *s, int item_id, void*mem); 
/**
 ...
 * @return APR_SUCCESS if all went well
 */
ngx_int_t (* ap_slotmem_lock)(ap_slotmem_t *s);
/**
 * Unlock the slotmem
 * @return APR_SUCCESS if all went well
 */
ngx_int_t (* ap_slotmem_unlock)(ap_slotmem_t *s);
/**
...
ngx_conf_t *cf;
ngx_http_module_t *ngx_http_module;
